...
# Import your earlier code properly
from data import DataGenerator, DistributionType
...
if __name__ == "__main__":
    ...
    for dist_type in distributions:
        for size in sizes:
            arr = DataGenerator.generate(size, dist_type)
            ...
            results.append({
                "distribution": DataGenerator.dist_to_string(dist_type),
                "size": int(size),
            ...
            print(f"Distribution: {DataGenerator.dist_to_string(dist_type)}")
